...
public class SlotLabelButtonClearPacket implements INetworkPacket {
    int slot = -1;

    public SlotLabelButtonClearPacket() {
    }

    public SlotLabelButtonClearPacket(int slot) {
        this.slot = slot;
    }
    ...
    public INetworkPacket clonePacket() {
        return new SlotLabelButtonClearPacket();
    }
